...
domainStates.concat(partialProtocolFileStates);
domainStates.concat(partialProtocolFtpStates);
domainStates.concat(partialProtocolHttpStates);
...
domainStates.concat(partialLocalhostStates);
