...
!function($, window, document) {
    ...
    Linkified.linkify = function(text, options) {
        ...
        1 === childNode.nodeType) Linkified.linkifyNode.call(this, childNode); else if (3 === childNode.nodeType) {
            ...
            for (offset = 0, linkifiedText = Linkified.linkify.call(this, childNode.textContent || childNode.innerText || childNode.nodeValue), 
            dummyElement.innerHTML = linkifiedText; dummyElement.firstChild; ) offset++, node.insertBefore(dummyElement.firstChild, childNode);
            node.removeChild(childNode), offset--, i += offset;
        }
        return node;
