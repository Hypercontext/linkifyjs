...
module.exports = {
	...
	linkifiedAlt:
		'Hello here are some links to <a ' +
		'href="ftp://awesome.com/?where=this" class="linkified" '+
		'target="_blank" rel="nofollow">ftp://awesome.com/?where=this</a> and <a ' +
		'href="http://localhost:8080" class="linkified" target="_blank" rel="nofollow">' +
		'localhost:8080</a>, pretty neat right? <p>Here\'s a nested ' +
		'<a href="http://github.com/SoapBox/linkifyjs" class="linkified" ' +
		'target="_blank" rel="nofollow">github.com/SoapBox/linkifyjs</a> paragraph</p>',
	altOptions: {
		linkAttributes: {
			rel: 'nofollow'
		}
